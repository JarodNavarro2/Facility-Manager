...
{
	public static ArrayList<Maintenance> maintain = new ArrayList<Maintenance>(); ///Storing the approved Maintenance
	public static ArrayList<Maintenance> maintain_request = new ArrayList<Maintenance>(); ///Storing the Maintenance requests
